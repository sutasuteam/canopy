...
func (x *NFT) GetBlockHeight() uint64 {
	if x != nil {
...
const file_tx_proto_rawDesc = "" +
	...
	"\tsignature\x18\x02 \x01(\fR\tsignature\"\x8b\x01\n" +
	...
	"\bmetadata\x18\x05 \x01(\tR\bmetadata\"\x9f\x01\n" +
	"\x03NFT\x12\x19\n" +
	...
	"\fblock_height\x18\x06 \x01(\x04R\vblockHeightB.Z,github.com/canopy-network/go-plugin/contractb\x06proto3"
...
var file_tx_proto_goTypes = []any{
	...
	(*MessageMintNFT)(nil), // 4: types.MessageMintNFT
	(*NFT)(nil),            // 5: types.NFT
